          ...
          <div className="flex flex-col h-full">
            ...
            {activeTab === "Conversation" && (
              <div className="h-full flex flex-col justify-end">
                ...
                <div className="border-t-2 p-2 border-green-300 sm:p-4 flex items-center gap-2">
                  <input
                    type="text"
                    placeholder="Type your reply here..."
                    className="flex-1 border-2 border-green-300 rounded-lg px-2 sm:px-3 py-2 focus:outline-none focus:ring-2 focus:ring-teal-400 h-12 sm:h-14"
                  />
